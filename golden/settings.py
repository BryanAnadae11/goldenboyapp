...
SECRET_KEY = 'django-insecure-f@rxu*(5^g$7&_ii@bcvq=7b7pr+-uny=j==h$-w4f5f3v(d#s'
...
EMAIL_PORT=465
EMAIL_USE_SSL=True
EMAIL_HOST_USER='support@integritydigitalholdings.org'
EMAIL_HOST_PASSWORD='Derico12345@'


DEFAULT_FROM_EMAIL= 'support@integritydigitalholdings.org'
