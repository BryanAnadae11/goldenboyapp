...
class Payment_id(models.Model):
	...
	investment_plan_name= models.CharField(default='MISSED-INFO', max_length=20, null=True, blank=True)
	contract_duration= models.FloatField(default=10, null=True, blank=True)
...
class Plan(models.Model):
    ...
    return_of_investment = models.CharField(max_length=2, blank=True, null=True)
    duration = models.IntegerField(default=0)
    referral= models.CharField(max_length=200, null=True)
    principal= models.CharField(max_length=200, default='Included', choices=PRINCIPAL_CHOICES)
    duration_measurement = models.CharField(
        max_length=64,
        default='Days',
        choices=DURATION_MEASUREMENT,
    )

    def __str__(self):
        return self.investment_name or "Unnamed Plan"
...
class Package(models.Model):
	...
	contract_duration_in_days= models.FloatField(default=10, null=True, blank=True)
